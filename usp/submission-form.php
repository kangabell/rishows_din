...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-title">
			<label for="user-submitted-title"><?php esc_html_e('Show Title', 'usp'); ?></label>
			<input id="user-submitted-title" name="user-submitted-title" type="text" value="" <?php if (usp_check_required('usp_title')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		...
		<fieldset class="usp-content">
			...
			<label for="user-submitted-content"><?php esc_html_e('Date, Venue, Time, Cost, Age Minimum (18+, all-ages, etc.)', 'usp'); ?></label>
			<textarea id="user-submitted-content" name="user-submitted-content" rows="5" <?php if (usp_check_required('usp_content')) echo $usp_required; ?> class="usp-textarea"></textarea>
			<?php } ?>
		...
		<?php } if (($usp_options['usp_name'] == 'show' || $usp_options['usp_name'] == 'optn') && ($usp_display_name)) { ?>
